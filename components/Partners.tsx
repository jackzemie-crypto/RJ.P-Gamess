...
const Partners: React.FC = () => {
  const [selectedPartner, setSelectedPartner] = useState<PartnerItem | null>(PARTNERS_DATA.length > 0 ? PARTNERS_DATA[0] : null);
  ...
  // If no partners, show empty state
  if (PARTNERS_DATA.length === 0) {
    return (
      <div className="flex h-full bg-bg text-white items-center justify-center p-10">
